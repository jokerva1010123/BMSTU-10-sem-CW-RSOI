...
func (h IncomeMainHandler) Show(w http.ResponseWriter, r *http.Request) {
	...
	income, err := h.Service.Get(r.Context(), id)
	if err != nil {
...
func (h *IncomeMainHandler) Add(w http.ResponseWriter, r *http.Request) {
	income := &income.IncomeCreationRequest{}
	...
	res, err := h.Service.Create(test, income)
	if err != nil {
...
func (h IncomeMainHandler) Update(w http.ResponseWriter, r *http.Request) {
	...
	incomeRequest := &income.IncomeCreationRequest{}
	...
	if err = myjson.From(body, incomeRequest); err != nil {
		myjson.JSONError(w, http.StatusBadRequest, err.Error())
		return
	}
	...
	test := context.WithValue(
		...
		"X-User-Name", r.Header.Get("X-User-Name"))
	res, err := h.Service.Update(test, id, incomeRequest)
	if err != nil {
		myjson.JSONError(w, http.StatusInternalServerError, err.Error())
		return
	}
...
func (h IncomeMainHandler) Delete(w http.ResponseWriter, r *http.Request) {
	...
	income, err := h.Service.Delete(r.Context(), id)
...
// func (h IncomeMainHandler) Create(w http.ResponseWriter, r *http.Request) error {
...
// 	myjson.JSONResponce(income, http.StatusCreated)
...
// func (h IncomeMainHandler) create(c *routing.Context) error {
// 	var input CreateAlbumRequest
// 	if err := c.Read(&input); err != nil {
// 		r.logger.With(c.Request.Context()).Info(err)
// 		return errors.BadRequest("")
...
// func (h IncomeMainHandler) update(c *routing.Context) error {
// 	var input UpdateAlbumRequest
// 	if err := c.Read(&input); err != nil {
// 		r.logger.With(c.Request.Context()).Info(err)
// 		return errors.BadRequest("")
...
// func (h IncomeMainHandler) delete(c *routing.Context) error {
